...
/**
 * @ClassName: WorkFlowBeforeAppendTaskCmdRequest
 * @Package: com.wb.workflow.core.cmd.request.task
 * @Description: the work flow before append task cmd request
 * @Author：[bo.wang]
 * @Date: 2021/3/1
 * @Version: 1.0
 */
public class WorkFlowBeforeAppendTaskCmdRequest extends WorkFlowGenericCmdRequest<Void> {
